...
import 'package:officeinventoryapp/data/models/furniture/post_furniture_req.dart';
import 'package:officeinventoryapp/core/constants/MyConstant.dart';

enum SelectedFurnitureType { Chair, Table, Shelving, Other }

class AddFurnitureScreen extends GetWidget<AddFurnitureController> {
                ...
                child: SingleChildScrollView(
                    child: Form(
                      ...
                      child: Container(
                        ...
                        Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                      padding:
                                          getPadding(left: 92, top: 7, bottom: 8),
                                      child: Text("lbl_add_furniture".tr,
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      CustomTextFormField(
                                          ...
                                          focusNode: FocusNode(),
                                          controller:
                                              controller.groupFiftySixController1,
                        ...
                        CustomButton(
                            width: 396,
                            text: "lbl_add_furniture".tr,
                            margin: getMargin(
                                left: 16, top: 50, right: 16, bottom: 20),
                            onTap: onTapBtnAddfurniture,
                            alignment: Alignment.center)
                      ])),
                    )))));
  }
  ...
  void onTapBtnAddfurniture() {
    if(_formKey.currentState!.validate()) {
      PostFurnitureReq postFurnitureReq = PostFurnitureReq(
        records: [
          Records(
            fields: Fields(
              furnitureName: controller.groupFiftySixController1.text,
      ...
      controller.callCreateFurniture(
        postFurnitureReq.toJson(),
        successCall: _onCreateFurnitureSuccess,
        errCall: _onCreateFurnitureError,
      );
    }
  }

  void _onCreateFurnitureSuccess() {
    Get.snackbar('', "Furniture Added");
    Get.offAndToNamed(AppRoutes.allFurnitureScreen);
  }

  void _onCreateFurnitureError() {
    Get.snackbar('', "Furniture Not Added");
  }
}

...
import 'package:officeinventoryapp/data/models/devices/put_devices_req.dart';
import 'package:officeinventoryapp/core/constants/MyConstant.dart';

enum SelectedDeviceType { Android, iOS, Laptop, Other }

class EditDeviceScreen extends GetWidget<EditDeviceController> {
                                    ...
                                    children: [
                                      ...
                                      CustomTextFormField(
                                          ...
                                          controller: controller
                                              .groupFiftySixController5.value,
  ...
  void onTapBtnSavechanges() {
    if(_formKey.currentState!.validate()) {
      PutDevicesReq putDevicesReq = PutDevicesReq(
        records: [
          Records(
            id: Get.find<PrefUtils>().getDeviceRecordId(),
            fields: Fields(
              name: controller.groupFiftySixController5.value.text,
      ...
      controller.callUpdateDevices(
        putDevicesReq.toJson(),
        successCall: _onUpdateDevicesSuccess,
        errCall: _onUpdateDevicesError,
      );
    }
  }

  void _onUpdateDevicesSuccess() {
    Get.offAndToNamed(AppRoutes.allDeviceScreen);
  }

  void _onUpdateDevicesError() {
    Get.snackbar('', "Device Not Edited");
  }
}
